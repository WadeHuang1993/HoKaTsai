                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                                ...
                                <a href="{{ route('home') }}#fqa" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">諮商Q&A</a>
                            </div>
                        </div>
                    ...
                    <div class="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <div class="relative">
                            ...
                            <div id="services-submenu" class="hidden pl-4">
                                ...
                                <a href="{{ route('home') }}#fqa" class="block px-3 py-2 text-gray-600 hover:text-gray-900">諮商Q&A</a>
                            </div>
                        </div>
